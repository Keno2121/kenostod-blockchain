...
const translations = {
    en: {
        ...
        'course.finance_foundations.title': 'Course 17: Personal Finance Foundations 💰',
        'course.finance_foundations.description': 'Master the fundamentals of personal finance and money management. Learn budgeting, emergency funds, debt management, credit scores, and financial goal setting. Build the foundation for lifelong financial success and break the cycle of poverty.',
        'course.finance_foundations.use_case': 'Essential life skills for everyone. Critical for students from low-income backgrounds to understand how money works, avoid common financial mistakes, and start building wealth from zero.',
        'course.finance_foundations.skills': ['Budgeting', 'Debt Management', 'Financial Planning', 'Credit Management'],
        'course.investing.title': 'Course 18: Investment Strategies & Compound Growth 📈',
        'course.investing.description': 'Understand investing fundamentals and the power of compound interest. Learn about stocks, bonds, index funds, cryptocurrency, and dollar-cost averaging. Discover how small, consistent investments can grow into life-changing wealth over time.',
        'course.investing.use_case': 'Transform earned income into passive wealth. Learn why investing $100/month for 30 years at 8% returns = $150,000+. Essential for building generational wealth and financial independence.',
        'course.investing.skills': ['Investment Strategies', 'Compound Interest', 'Portfolio Management', 'Risk Assessment'],
        'course.wealth_building.title': 'Course 19: Wealth Building & Asset Allocation 💎',
        'course.wealth_building.description': 'Advanced wealth accumulation strategies. Learn multiple income streams, asset diversification, real estate basics, business ownership, and tax optimization. Understand how the wealthy build and preserve multi-generational fortunes.',
        'course.wealth_building.use_case': 'Bridge the wealth gap. Students learn how to build $500K-$2M+ net worth over 10-20 years through strategic asset allocation, even starting from poverty.',
        'course.wealth_building.skills': ['Asset Diversification', 'Income Streams', 'Wealth Preservation', 'Tax Strategy'],
        'course.generational_wealth.title': 'Course 20: Generational Wealth Planning 🏛️',
        'course.generational_wealth.description': 'Create wealth that lasts for generations. Learn estate planning, trusts, inheritance strategies, family financial education, and how to pass wealth to children and grandchildren. Break the cycle of poverty for your entire family tree.',
        'course.generational_wealth.use_case': 'The ultimate goal: financial freedom for your descendants. Learn how families like the Rockefellers and Rothschilds preserve wealth across centuries, and apply those principles to your situation.',
        'course.generational_wealth.skills': ['Estate Planning', 'Wealth Transfer', 'Family Finance', 'Legacy Building'],
        'course.economic_empowerment.title': 'Course 21: Economic Empowerment & Poverty Reduction 🌍',
        'course.economic_empowerment.description': 'Use blockchain and financial knowledge to lift communities out of poverty. Learn microfinance, community investment, social entrepreneurship, and how technology enables global economic opportunity. Discover your role in reducing global poverty.',
        'course.economic_empowerment.use_case': 'Turn education into impact. Graduates use blockchain skills to earn remote income, create jobs, educate their communities, and help others escape poverty. Real stories of $200/month income → $4,000/month transformation.',
        'course.economic_empowerment.skills': ['Social Impact', 'Community Development', 'Global Economics', 'Entrepreneurship']
    },
    es: {
        ...
        'course.finance_foundations.title': 'Curso 17: Fundamentos de Finanzas Personales 💰',
        'course.finance_foundations.description': 'Domina los fundamentos de las finanzas personales y la gestión del dinero. Aprende presupuestación, fondos de emergencia, gestión de deudas, puntajes de crédito y establecimiento de metas financieras. Construye la base para el éxito financiero de por vida y rompe el ciclo de la pobreza.',
        'course.finance_foundations.use_case': 'Habilidades esenciales para todos. Crítico para estudiantes de entornos de bajos ingresos para entender cómo funciona el dinero, evitar errores financieros comunes y comenzar a construir riqueza desde cero.',
        'course.finance_foundations.skills': ['Presupuestación', 'Gestión de Deudas', 'Planificación Financiera', 'Gestión de Crédito'],
        'course.investing.title': 'Curso 18: Estrategias de Inversión y Crecimiento Compuesto 📈',
        'course.investing.description': 'Comprende los fundamentos de la inversión y el poder del interés compuesto. Aprende sobre acciones, bonos, fondos indexados, criptomonedas y promediación del costo en dólares. Descubre cómo pequeñas inversiones consistentes pueden convertirse en riqueza que cambia la vida con el tiempo.',
        'course.investing.use_case': 'Transforma ingresos ganados en riqueza pasiva. Aprende por qué invertir $100/mes durante 30 años al 8% de retorno = $150,000+. Esencial para construir riqueza generacional e independencia financiera.',
        'course.investing.skills': ['Estrategias de Inversión', 'Interés Compuesto', 'Gestión de Cartera', 'Evaluación de Riesgos'],
        'course.wealth_building.title': 'Curso 19: Construcción de Riqueza y Asignación de Activos 💎',
        'course.wealth_building.description': 'Estrategias avanzadas de acumulación de riqueza. Aprende flujos de ingresos múltiples, diversificación de activos, conceptos básicos de bienes raíces, propiedad de negocios y optimización fiscal. Entiende cómo los ricos construyen y preservan fortunas multigeneracionales.',
        'course.wealth_building.use_case': 'Cierra la brecha de riqueza. Los estudiantes aprenden cómo construir $500K-$2M+ de patrimonio neto en 10-20 años a través de la asignación estratégica de activos, incluso comenzando desde la pobreza.',
        'course.wealth_building.skills': ['Diversificación de Activos', 'Flujos de Ingresos', 'Preservación de Riqueza', 'Estrategia Fiscal'],
        'course.generational_wealth.title': 'Curso 20: Planificación de Riqueza Generacional 🏛️',
        'course.generational_wealth.description': 'Crea riqueza que dure por generaciones. Aprende planificación patrimonial, fideicomisos, estrategias de herencia, educación financiera familiar y cómo transferir riqueza a hijos y nietos. Rompe el ciclo de pobreza para todo tu árbol familiar.',
        'course.generational_wealth.use_case': 'El objetivo final: libertad financiera para tus descendientes. Aprende cómo familias como los Rockefeller y los Rothschild preservan riqueza a través de siglos, y aplica esos principios a tu situación.',
        'course.generational_wealth.skills': ['Planificación Patrimonial', 'Transferencia de Riqueza', 'Finanzas Familiares', 'Construcción de Legado'],
        'course.economic_empowerment.title': 'Curso 21: Empoderamiento Económico y Reducción de Pobreza 🌍',
        'course.economic_empowerment.description': 'Usa blockchain y conocimiento financiero para sacar comunidades de la pobreza. Aprende microfinanzas, inversión comunitaria, emprendimiento social y cómo la tecnología permite oportunidad económica global. Descubre tu rol en reducir la pobreza global.',
        'course.economic_empowerment.use_case': 'Convierte educación en impacto. Los graduados usan habilidades blockchain para ganar ingresos remotos, crear empleos, educar sus comunidades y ayudar a otros a escapar la pobreza. Historias reales de $200/mes → $4,000/mes de transformación.',
        'course.economic_empowerment.skills': ['Impacto Social', 'Desarrollo Comunitario', 'Economía Global', 'Emprendimiento']
    },
    zh: {
        'nav.logo': 'Kenostod学院',
