...
- **Dec 25, 2025:** Node Sale System - Created comprehensive node sale design document, landing page (/node-sale.html), and PostgreSQL-backed whitelist registration system. Three node tiers (Scholar $299, Educator $799, Academy $1,999) with 4 utility functions: course validation, KENO distribution, FAL calculations, credential verification. Countdown to Q1 2026 launch.
