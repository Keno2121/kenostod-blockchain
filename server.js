...
// Docs landing page
app.get('/student-earn-model', (req, res) => res.sendFile(__dirname + '/public/docs/student-earn-model.html'));
app.get('/docs/student-earn-model', (req, res) => res.sendFile(__dirname + '/public/docs/student-earn-model.html'));
    ...
    res.json({
        ...
        bots: [
            ...
            // ── Sovereign Bot Framework (4 bots) ───────────────────────────────────
            {
                ...
                name:        'Sovereignty Harvester',
                emoji:       '🛡️',
                chain:       'Solana → BSC',
                description: 'SHIELD Aegis Tax flywheel — monitors Solana treasury, bridges SOL to BNB, triggers KENOAutoBurn. KENO supply ↓ → price ↑.',
                controllable: true,
                startUrl:    '/api/sovereign/bot/1/start',
                stopUrl:     '/api/sovereign/bot/1/stop',
                statusUrl:   '/api/sovereign/bot/1/status',
                ...sovereignBots.harvester.getStatus(),
            },
            {
                id:          'utl-pulse',
                name:        'UTL Pulse Bot',
                emoji:       '⚡',
                chain:       'BSC',
                description: 'Monitors UTL FeeCollector USDC balance — distributes earnings via Kaprekar split (25% founder / 60% reinvest / 15% burn) on every cycle.',
                controllable: true,
                startUrl:    '/api/sovereign/bot/2/start',
                stopUrl:     '/api/sovereign/bot/2/stop',
                statusUrl:   '/api/sovereign/bot/2/status',
                ...sovereignBots.utlPulse.getStatus(),
            },
            {
                id:          'wkeno-bridge',
                name:        'wKENO Bridge Watcher',
                emoji:       '🌉',
                chain:       'BSC → Base/Polygon',
                description: 'Watches KENO/wKENO cross-chain parity gap — alerts when spread > 1% and optionally auto-arbitrages the bridge discount.',
                controllable: true,
                startUrl:    '/api/sovereign/bot/3/start',
                stopUrl:     '/api/sovereign/bot/3/stop',
                statusUrl:   '/api/sovereign/bot/3/status',
                ...sovereignBots.bridgeWatch.getStatus(),
            },
            {
                id:          'porv-optimizer',
                name:        'PoRV Mining Optimizer',
                emoji:       '⛏️',
                chain:       'Kenostod Chain',
                description: 'Proof-of-Residual-Value auto-compound — monitors PoRV mining rewards, applies Euler continuous compounding, auto-stakes when profitable.',
                controllable: true,
                startUrl:    '/api/sovereign/bot/4/start',
                stopUrl:     '/api/sovereign/bot/4/stop',
                statusUrl:   '/api/sovereign/bot/4/status',
                ...sovereignBots.porvOpt.getStatus(),
            },
        ]
    });
});
