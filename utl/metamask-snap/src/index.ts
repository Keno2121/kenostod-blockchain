...
const UTL_FEE_COLLECTOR = '0x0000000000000000000000000000000000000000'; // Deploy address TBD
const UTL_STAKING = '0x0000000000000000000000000000000000000000';     // Deploy address TBD
  ...
  if (!state.isOptedIn) {
    return {
      content: panel([
        ...
        divider(),
        text('**Opt in to earn passive income** from every transaction across the network.'),
