...
async function main() {
  ...
  if (balance < ethers.parseEther("0.001")) {
    throw new Error("Insufficient ETH on Base. Fund " + deployer.address + " with at least 0.002 ETH on Base.");
  }
  ...
  console.log("   npx hardhat verify --network base", address, '"' + SAFE_WALLET + '"');
  console.log("\n2. Add to Phantom (Base network):");
